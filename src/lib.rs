...
World's tiniest TGA encoder.

This is a small library for writing TGA images.  Designed for dumping GPU textures to disk.

The library supports writing 32-bit BGRA textures; other formats may be supported in the future.
